...
">
    ...
    <li><a href="index.php?page=display_center"><span class="glyphicon glyphicon-user"></span>  Centers</a></li>
	<li><a href="index.php?page=display_member"><span class="glyphicon glyphicon-user"></span>  Members</a></li>
	<li><a href="index.php?page=groups"><span class="glyphicon glyphicon-blackboard"></span>Groups</a></li>
	<li><a href="index.php?page=display_loan"><span class="glyphicon glyphicon-euro"></span> Loan</a></li>
	<li><a href="index.php?page=display_loantype"><span class="glyphicon glyphicon-book"></span> Loan Type</a></li>
	<li><a href="index.php?page=add_payment"><span class="glyphicon glyphicon-wrench"></span>Add Payment</a></li>
		...
		@$page=  $_GET['page'];
		  if($page!="")
		  {
		  	if($page=="add_center")
			{
				include('add_center.php');
			
			}
		  	if($page=="display_center")
			{
				include('display_center.php');
			
			}
			if($page=="search_center")
			{
				include('search_center.php');
			...
			if($page=="display_loantype")
			{
				include('display_loantype.php');
			
			}
			
			if($page=="add_loantype")
			{
				include('add_loantype.php');
